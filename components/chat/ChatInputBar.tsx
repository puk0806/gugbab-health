...
export default function ChatInputBar({
    ...
    // 상태 배선(listening/interim/error·stale 세션 가드·언마운트 abort)은 훅이 담당.
    // onFinal은 latest-ref로 호출되므로 항상 최신 value를 읽는다.
    const {
        ...
        lang: "ko-KR",
        onFinal: (transcript) => onChange(appendTranscript(value, transcript, maxLength)),
    });
